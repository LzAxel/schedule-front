...
export const ScheduleTableItem: FC<Props> = ({title, teacher, place, parity}) => {
    return (
        <div
            className={clsx(parity === 'static' && 'max-h-full h-full', "bg-gradient max-h-[130px] shrink-0 rounded-sm flex border border-border flex-col gap-[8px] p-[16px] justify-between overflow-hidden shadow-sm min-w-[150px]")}>
