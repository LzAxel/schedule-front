					...
					<Card className="border-yellow-200 bg-yellow-50 dark:border-yellow-800 dark:bg-yellow-950/20">
						...
						<CardContent>
							<CardDescription className="text-yellow-700 dark:text-yellow-300">
								Новые администраторы получат полный доступ к системе управления расписанием. Убедитесь,
								что вы доверяете пользователю перед предоставлением административных прав.
							</CardDescription>
						</CardContent>
					</Card>
						...
						<div className="space-y-6">
							<Card>
								<CardHeader>
									...
									<CardDescription>
										Все пользователи с административными правами в системе
									</CardDescription>
								</CardHeader>
								<CardContent>
